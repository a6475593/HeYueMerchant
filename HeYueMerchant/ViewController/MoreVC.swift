...
class MoreVC: BaseViewController,UIAlertViewDelegate,UMSocialUIDelegate{
    ...
    @IBOutlet weak var VersionMessageTView: UIView!
    ...
    override func viewDidLayoutSubviews() {
        ...
        MessageTextView.frame = CGRectMake(0, 0, VersionMessageTView.frame.width, VersionMessageTView.frame.height)
        MessageTextView.selectable = false
        MessageTextView.editable = false

        
        MessageTextView.text = "1.七重天BOSS已到最后阶段，合力击败BOSS即可进入下一重天。\n元神等级上限再提升、更高级元神装备、全新徽章即将开启，相约九重天，全力打BOSS!(1)元神等级上限提升至110级，元神装备开放至帝级\n(2)全新神眼徽章：三界商人亲密度提升\n(3)神之禁地新区域同步开放\n2.植树节活动启动，春暖花开万物复苏之际，赶快来参与灭妖环保，拿最新元神礼包!登上植树排行榜，还有机会获得高级陨星、白虎碎片，更有做人要低调称号等你来!\n3.宠物新技能上线啦，打造强力战斗辅助，开启战斗新篇章，快来为宠物解锁新能力吧!\n(1)神宠白虎独享专属技能：如虎添翼，不但有几率免疫受到的伤害，还可激活霸气新外观\n(2)珍贵宠物将获得超强新技能\n(3)新增哪吒、巨灵两个珍贵品质宠物\n4.“银汉游戏服务中心”微信公众号上线啦，你的专属小秘书，有问必答游戏无忧，快来绑定吧!\n【国战小组赛】\n3月13日20:00-21:15(8进4)\n3月14日20:00-20:35(4进2)\n3月15日\n20:00-20:15(季军赛)\n3月15日20:20-20:35(冠军赛)\n注：比赛期间严打外挂，一旦发现使用外挂者,将取消成绩并封停帐号处理!\n【优化内容】\n1.宝宝工作收益调整：召唤BOSS奖励福禄宝石更改为绑金\n【后续开发预告】\n1.群雄并起，三界大战一触即发，阵营新玩法即将开启，敬请期待!ssssssssss收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾收拾收拾收拾收拾sssssssjkldfasjkflkdsjflsdkjflsdkfjlsdfjlsdfjlsdfjlsdfjlsdfjlsd辅导课龙丰街道酸辣粉就死定了福建师大了辅导老师发送雷锋精神砥砺风节扫到了分手代理开发建设雷锋精神登录ssssssssss收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾收拾收拾收拾收拾sssssssjkldfasjkflkdsjflsdkjflsdkfjlsdfjlsdfjlsdfjlsdfjlsdfjlsd辅导课龙丰街道酸辣粉就死定了福建师大了辅导老师发送雷锋精神砥砺风节扫到了分手代理开发建设雷锋精神登录ssssssssss收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾收拾收拾收拾收拾sssssssjkldfasjkflkdsjflsdkjflsdkfjlsdfjlsdfjlsdfjlsdfjlsdfjlsd辅导课龙丰街道酸辣粉就死定了福建师大了辅导老师发送雷锋精神砥砺风节扫到了分手代理开发建设雷锋精神登录ssssssssss收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾是收拾收拾收拾收拾收拾收拾sssssssjkldfasjkflkdsjflsdkjflsdkfjlsdfjlsdfjlsdfjlsdfjlsdfjlsd辅导课龙丰街道酸辣粉就死定了福建师大了辅导老师发送雷锋精神砥砺风节扫到了分手代理开发建设雷锋精神登录"
        MessageTextView.textAlignment = NSTextAlignment.Left
        
        
    VersionMessageTView.addSubview(MessageTextView)
