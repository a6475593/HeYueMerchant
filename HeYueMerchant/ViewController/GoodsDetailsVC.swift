...
class GoodsDetailsVC: BaseViewController,UITextFieldDelegate,UITextViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        goodsCountsButton.addTarget(self, action: #selector(GoodsDetailsVC.goodsgountsbuttonaction), forControlEvents: .TouchUpInside)
        mobileButton.addTarget(self, action: #selector(GoodsDetailsVC.mobilebuttonaction), forControlEvents: .TouchUpInside)
        confirmButton.addTarget(self, action: #selector(GoodsDetailsVC.confirmbuttonaction), forControlEvents: .TouchUpInside)
    ...
    func setupView(){
        ...
        let SearchButton = UIBarButtonItem(title: "查询余额", style: UIBarButtonItemStyle.Done, target: self, action: #selector(GoodsDetailsVC.searchremainingaction))
